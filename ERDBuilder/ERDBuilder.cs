...
namespace LinkeD365.ERDBuilder
{
    ...
    [Export(typeof(IXrmToolBoxPlugin)),
        ExportMetadata("Name", "ERD Visio Builder"),
        ExportMetadata("Description", "A tool to generate Visio ERDs from entities and relationships in your CDS"),
    ...
    public class ERDBuilder : PluginBase
    {
        public override IXrmToolBoxPluginControl GetControl()
        {
            return new ERDBuilderControl();
        }
